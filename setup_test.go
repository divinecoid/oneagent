...
func main() {
	...
	registerResponseJSON, _ := json.MarshalIndent(registerResponse, "", "  ")
	...
	configBody := map[string]interface{}{
		...
		"basic_prompt":            "You are a helpful shopping assistant that provides recommendations based on product information. Please respond in Indonesian language. Keep responses concise and natural. Focus on the relevant product features and benefits that match the user's query.",
